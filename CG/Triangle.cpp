...
{
	vertices[0].vertex = Vector4(v1[0], v1[1], v1[2], 1);
	vertices[1].vertex = Vector4(v2[0], v2[1], v2[2], 1);
	vertices[2].vertex = Vector4(v3[0], v3[1], v3[2], 1);
	this->normal = getCrossNormal();
	memset(gradient, 0.0, sizeof(gradient));
}
...
Triangle::Triangle(int * v1, int * v2, int * v3, int * n1, int * n2, int * n3)
{
	...
	vertices[1].vertex = Vector4(v2[0], v2[1], v2[2], 1);
	vertices[2].vertex = Vector4(v3[0], v3[1], v3[2], 1);
	vertices[0].normal = Vector4(n1[0], n1[1], n1[2], 1);
	vertices[1].normal = Vector4(n2[0], n2[1], n2[2], 1);
	vertices[2].normal = Vector4(n3[0], n3[1], n3[2], 1);
	this->normal = calcNormal();
	memset(gradient, 0.0, sizeof(gradient));
}
/*
